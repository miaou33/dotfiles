...
cmp.setup {
  ...
  window = {
    completion = {
      border = { "╭", "─", "╮", "│", "╯", "─", "╰", "│" },
      winhighlight = "Normal:CmpPmenu,CursorLine:PmenuSel,Search:PmenuSel,BorderFloat:BorderBG",
      side_padding = 1,
      --scrollbar = true,
    },
    documentation = {
      border = { "╭", "─", "╮", "│", "╯", "─", "╰", "│" },
      winhighlight = "Normal:CmpDo,CursorLine:PmenuSel,Search:PmenuSel,BorderFloat:BorderBG",
    },
  },
  experimental = {
    ghost_text = false,
